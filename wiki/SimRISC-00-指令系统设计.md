...
| `set.ft` | `set.ft rfxx, imm32` | `set.w`（1~2 条） | 加载单精浮点立即数 | SimRISC-03 §set.ft / set.fo 伪指令 |
| `set.fo` | `set.fo rfxx, imm64` | `set.w`（1~4 条） | 加载双精浮点立即数 | SimRISC-03 §set.ft / set.fo 伪指令 |
