...
| `INTEG-003t` | 跨模块接口对齐核对 | 接口核对清单/脚本 | `LLVM-013m`、`QEMU-021m`、`SPEC-011m`、`TESTCASES-012m` |
...
**依赖现状**：`SPEC-010t`/`SPEC-011m`/`LLVM-013m`/`QEMU-021m` 均存在且后两者已是**里程碑** ✓ ⇒ `002t`/`003t` 的前置已就绪 ✓。
