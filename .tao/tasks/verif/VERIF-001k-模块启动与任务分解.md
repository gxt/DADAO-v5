...
- **借鉴**：DADAO-0628 的 ADR-0009 验证链（M1 引用审计、M2a 黄金模型、M3 生成式合法性矩阵）与 Phase 4（MC↔QEMU 集成）。
...
| 编号 | 任务 | 交付物 | 依赖 |
|------|------|--------|------|
| `VERIF-002t` | 合法性规则与验证器 | `verif/legality_rules.yaml`、`verif/validate_encoding.py` | `SPEC-003t` |
