...
| 编号 | 任务 | 交付物 | 依赖 |
|------|------|--------|------|
| `TESTSUITE-002t` | 向量 schema + inventory + validator | `tests/vectors/schema.md`、`inventory.md`、`README.md`、`isa/*.yaml`、`verif/validate_vectors.py`、`Makefile` check 集成 | `SPEC-003t` |
