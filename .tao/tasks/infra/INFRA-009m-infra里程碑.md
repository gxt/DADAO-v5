...
- **引用一致性前置**：✅ **已处置**——`INFRA-001k`（ADR-0001/0002）与 `Makefile`（第 3 行注释）的 ADR 引用已补明 v5 路径（`.tao/knowledge/adr-0001-greenfield-rebuild.md` / `adr-0002-build-orchestration.md`）。
