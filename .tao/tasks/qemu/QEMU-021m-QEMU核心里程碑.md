...
**关联任务**：`QEMU-002t`、`QEMU-003t`、`QEMU-004t`、`QEMU-005t`、`QEMU-006t`、`QEMU-007t`、`QEMU-008t`、`QEMU-009t`、`QEMU-010t`、`QEMU-011t`、`QEMU-012t`、`QEMU-013t`、`QEMU-014t`、`QEMU-015t`、`QEMU-016t`、`QEMU-017t`、`QEMU-018t`、`QEMU-019t`、`QEMU-020t`

> **ADR-0010 D3 修订（2026-09-19）**：补丁清单更新为 0001–0007（合并后）；关联任务新增 `QEMU-020t`（harness dumper 改造）。
...
- 各任务产出的文件是否都存在：
  ...
  - `components/qemu/patches/series`（含 0001–0007）
