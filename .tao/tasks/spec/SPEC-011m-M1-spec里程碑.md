...
**模块**：spec
**状态**：待开始
**目标**：DADAO-v5 的 M1 规格基线完成——SimRISC 0.5.3 的 ISA 合约/编码表（Phase 1）之上，ABI 合约、Object ABI ADR、Test Machine ADR、ELF 合约均已创建并 Accepted，规格冻结动作（impact matrix + drift 检查）完成，spec 基线冻结
